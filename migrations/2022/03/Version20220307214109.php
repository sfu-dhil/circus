 ...
 */
final class Version20220307214109 extends AbstractMigration {
    ...
    public function up(Schema $schema) : void {
        ...
        $this->addSql('ALTER TABLE category CHANGE name name VARCHAR(200) NOT NULL, CHANGE label label VARCHAR(200) NOT NULL, CHANGE created created DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated updated DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE clipping CHANGE created created DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated updated DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE source CHANGE name name VARCHAR(200) NOT NULL, CHANGE label label VARCHAR(200) NOT NULL, CHANGE created created DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated updated DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema) : void {
        ...
        $this->addSql('ALTER TABLE clipping CHANGE original_name original_name VARCHAR(128) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE image_file_path image_file_path VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE thumbnail_path thumbnail_path VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE number number VARCHAR(24) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE written_date written_date VARCHAR(24) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date date VARCHAR(10) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE transcription transcription LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE annotations annotations LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE created created DATETIME NOT NULL, CHANGE updated updated DATETIME NOT NULL');
        $this->addSql('ALTER TABLE nines_blog_page DROP FOREIGN KEY FK_23FD24C7A76ED395');
        $this->addSql('ALTER TABLE nines_blog_page CHANGE in_menu in_menu TINYINT(1) DEFAULT 1 NOT NULL, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE searchable searchable LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE created created DATETIME NOT NULL, CHANGE updated updated DATETIME NOT NULL, CHANGE excerpt excerpt LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE nines_blog_post_category CHANGE name name VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE label label VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE created created DATETIME NOT NULL, CHANGE updated updated DATETIME NOT NULL');
